...
public class MaxFront extends CommandBase {

  private FrontClimberHoldPercentage frontClimber = new FrontClimberHoldPercentage(1.0, 0.05, 0, new ArrayList<CommandBase>());
  private RearClimberHoldPercentage rearClimber = new RearClimberHoldPercentage(0.0, 0.05, 0, new ArrayList<CommandBase>());
  
  private List<CommandBase> cancelCommands;

  /** Creates a new MaxFront. */
  public MaxFront(List<CommandBase> cancelCommands) {
  ...
  public void initialize() {
    ...
    System.out.println("MaxFront" + ", tolerance: " + isFinished());
  }
