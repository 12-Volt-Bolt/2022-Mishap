...
public class FrontLetUp extends CommandBase {

  private FrontClimberHoldPercentage frontClimber = new FrontClimberHoldPercentage(0.0, 0.05, 0, new ArrayList<CommandBase>());
  private RearClimberHoldPercentage rearClimber = new RearClimberHoldPercentage(0.1, 0.05, 0, new ArrayList<CommandBase>());
  
  private List<CommandBase> cancelCommands;

  /** Creates a new FrontLetUp. */
  public FrontLetUp(List<CommandBase> cancelCommands) {
  ...
  public void initialize() {
    ...
    System.out.println("FrontLetUp" + ", tolerance: " + isFinished());
  }
