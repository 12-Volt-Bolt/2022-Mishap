...
public class MidRear extends CommandBase {

  private FrontClimberHoldPercentage frontClimberDown = new FrontClimberHoldPercentage(0.4, 0.05, 0, new ArrayList<CommandBase>());
  private RearClimberHoldPercentage rearClimberDown = new RearClimberHoldPercentage(0.0, 0.05, 0, new ArrayList<CommandBase>());
  
  private List<CommandBase> cancelCommands;

  /** Creates a new MidFront. */
  public MidRear(List<CommandBase> cancelCommands) {
  ...
  public void initialize() {
    ...
    System.out.println("MidRear" + ", tolerance: " + isFinished());
  }
