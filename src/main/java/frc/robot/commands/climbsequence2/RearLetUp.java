...
public class RearLetUp extends CommandBase {

  private FrontClimberHoldPercentage frontClimber = new FrontClimberHoldPercentage(0.0, 0.05, 0, new ArrayList<CommandBase>());
  private RearClimberHoldPercentage rearClimber = new RearClimberHoldPercentage(0.5, 0.05, 0, new ArrayList<CommandBase>());
  
  private List<CommandBase> cancelCommands;

  /** Creates a new RearLetUp. */
  public RearLetUp(List<CommandBase> cancelCommands) {
  ...
  public void initialize() {
    ...
    System.out.println("RearLetUp" + ", tolerance: " + isFinished());
  }
