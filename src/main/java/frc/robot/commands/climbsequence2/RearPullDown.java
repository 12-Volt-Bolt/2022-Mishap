...
public class RearPullDown extends CommandBase {
  ...
  private RearClimberHoldPercentage rearClimberDown = new RearClimberHoldPercentage(0.1, 0.05, 0, new ArrayList<CommandBase>());
  
  private List<CommandBase> cancelCommands;

  /** Creates a new RearPullDown. */
  public RearPullDown(List<CommandBase> cancelCommands) {
  ...
  public void initialize() {
    ...
    System.out.println("RearPullDown" + ", tolerance: " + isFinished());
  }
